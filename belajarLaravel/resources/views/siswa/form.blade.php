    ...
    @include('templates/feedback')
      ...
      <div class="box">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
              <textarea type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Lengkap">{!! @$result->alamat !!}</textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-sm-10 col-sm-offset-2">
            <button type="submit" class="btn btn-primary"><i class="fa fa-sace"></i>Simpan</button>
          </div>
        </div>
        </form>
        </div>
